...
function add_user(namee, email, pos, aadhar, pan, score) {
    console.log("add user : " + namee + " " + email + " " + pos + " " + aadhar + " " + pan + " " + score)
    console.log(AgentContract);
...
function getRegisterData() {
    ...
    add_user(firstName + " " + lastName, emailAdd, pos, aadharNo, pan, 1211)
}
